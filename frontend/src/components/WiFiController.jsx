      ...
      <Paper sx={{ mb: 3 }}>
        ...
        {iframeError && (
          <Alert severity="warning" sx={{ mb: 2 }}>
            The admin panel could not be loaded in the iframe. This may be due
            to network issues or browser security restrictions.
            <Button
              size="small"
              startIcon={<OpenInNewIcon />}
              onClick={() => window.open(internetAccessUrl, "_blank")}
          ...
          {iframeError && (
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary" align="center">
                The page at <code>{internetAccessUrl}</code> could not be
                loaded.
              </Typography>
              <Button
                variant="contained"

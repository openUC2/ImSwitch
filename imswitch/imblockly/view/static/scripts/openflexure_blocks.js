...
Blockly.JavaScript['capture'] = function (block) {
  var code = `doMicroscopeAction("actions/camera/capture", "{}");\n`
  return code;
};
...
Blockly.JavaScript['move_relative'] = function (block) {
  ...
  var payload = `"{\\"absolute\\": false, \\"x\\": ${value_x_steps}, \\"y\\": ${value_y_steps}, \\"z\\": ${value_z_steps}}"`
  var code = `doMicroscopeAction("actions/stage/move", ${payload});\n`;
  return code;
};
...
Blockly.JavaScript['move_stage'] = function (block) {
  ...
  let axis_name = dropdown_axis_name[0].toLowerCase();
  var code = (

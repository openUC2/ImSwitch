...
spec = importlib.util.spec_from_file_location('StresstestController', 
    '/home/runner/work/ImSwitch/ImSwitch/imswitch/imcontrol/controller/controllers/StresstestController.py')

...
class Tucam():
    ...
    # ch:打印帧平均灰度值 | en:Print average gray
    ...
    # ch:设置自动曝光 | en:Set auto exposure
...
if __name__ == '__main__':
    ...
    if demo.TUCAMOPEN.hIdxTUCam != 0:
        demo.SetAutoExposure()
        # ch:设置10ms曝光时间 | en:Set 10ms exposure time
        demo.SetExposure(10)
        # ch:设置20ms曝光时间 | en:Set 20ms exposure time
        demo.SetExposure(20)
        # ch:设置30ms曝光时间 | en:Set 30ms exposure time
        demo.SetExposure(30)
        demo.CloseCamera()
    demo.UnInitApi()

...
class DMDWidget(NapariHybridWidget):
    ...
    def __post_init__(self):
        ...
        # Offset subtraction to suppress background in RMS (units: ADU counts)
        grid.addWidget(QtWidgets.QLabel("Offset"), 3, 0)
        self.offsetSpin = QtWidgets.QDoubleSpinBox()
        self.offsetSpin.setDecimals(1)
        self.offsetSpin.setRange(0.0, 65535.0)
        self.offsetSpin.setSingleStep(1.0)
        self.offsetSpin.setValue(2.0)
        self.offsetSpin.setToolTip("Constant value subtracted from each frame before IOS RMS. Set based on background intensity. 0 disables.")
        grid.addWidget(self.offsetSpin, 3, 1)
        ...
        # 3-shot + reconstruction buttons (moved to row 4)
        self.btnThreeShot = QtWidgets.QPushButton("Run 3-shot (0-1-2)")
        self.btnReconstruct = QtWidgets.QPushButton("Reconstruction (IOS)")
        grid.addWidget(self.btnThreeShot, 4, 0, 1, 2)
        grid.addWidget(self.btnReconstruct, 4, 2)
        ...
        grid.addWidget(self.chkWidefield, 5, 0)
        ...
        grid.addWidget(self.chkExport, 5, 1)
        ...
        grid.addWidget(self.chkExportRaw, 5, 2)
        ...
        grid.addWidget(QtWidgets.QLabel("Base Name"), 6, 0)
        grid.addWidget(self.exportNameEdit, 6, 1, 1, 3)
        ...
        grid.addWidget(QtWidgets.QLabel("Dir"), 7, 0)
        grid.addWidget(self.exportDirEdit, 7, 1, 1, 2)
        grid.addWidget(self.btnBrowseDir, 7, 3)

        # Status (scrollable, fixed height)
        ...
        grid.addWidget(self.statusEdit, 8, 0, 1, 4)
    ...
    def getOffset(self) -> float:
        return float(self.offsetSpin.value())

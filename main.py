if __name__ == '__main__':
    ...
    '''
    main(is_headless=False) #default_config="/Users/bene/ImSwitchConfig/imcontrol_setups/example_virtual_microscope.json", is_headless=True, http_port=8002) ## this has to be maintained for DOCKER!
